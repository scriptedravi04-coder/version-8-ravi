...
export const VALID_NICHES = [
  "Fashion & Style", "Beauty & Makeup", "Tech & Gadgets",
  "Gaming & Esports", "Food & Culinary", "Travel & Adventure",
  "Fitness & Health", "Finance & Crypto", "Education & Learning",
  "Comedy & Entertainment", "Arts & Design", "Music & Dance",
  "Parenting & Family", "Automotive", "Business & Entrepreneurship",
  "Home & Decor", "DIY & Crafts", "Pets & Animals", 
  "Sports", "Photography & Video", "Real Estate",
  "Vlog & Lifestyle", "Productivity", "Skincare", "Streetwear"
];
