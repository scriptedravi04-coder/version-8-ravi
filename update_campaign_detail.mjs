...
const targetStr = `      // 2. Open step-by-step processing stepper!
...
const newStr = `      toast.success("Application submitted successfully! It has been moved to pending.");
...
if (code.includes(targetStr)) {
  ...
  console.log("Not found CampaignDetail.jsx target");
}
