...
// I will just replace the whole file content to make it clean.
...
fs.writeFileSync('src/pages/BrandUGCOrders.jsx', newCode);
console.log("Success rewriting BrandUGCOrders");
