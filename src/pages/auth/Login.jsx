...
const USPS = [
  {
    ...
    stats: [
      { num: "12K+", text: "Creators" },
      { num: "2K+", text: "Brands" },
      { num: "₹5Cr+", text: "Paid Out" }
    ]
  },
  {
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              onClick={(e) => {
                ...
                localStorage.setItem("ybex_token", "dev_bypass");
                setUser(fakeUser);
                toast.success("Bypassed login (Creator Mode)");
                navigate("/dashboard");
              }}
              className="w-full bg-[var(--violet)]/10 border border-[var(--violet)]/20 py-2 sm:py-2.5 text-xs font-bold text-[#7C5CFF] hover:bg-[var(--violet)]/20 transition-all rounded-xl shadow-sm text-center"
            >
              Dev Bypass (Creator)
            </button>
            ...
            <button
              ...
              onClick={(e) => {
                ...
                localStorage.setItem("ybex_token", "dev_bypass_brand");
                setUser(fakeUser);
                toast.success("Bypassed login (Brand Mode)");
                navigate("/dashboard");
              }}
              className="w-full bg-[#D9F111]/10 border border-[#D9F111]/20 py-2 sm:py-2.5 text-xs font-bold text-[#b5cb0f] hover:bg-[#D9F111]/20 transition-all rounded-xl shadow-sm text-center"
            >
              Dev Bypass (Brand)
            </button>
            ...
            <button
              ...
              onClick={(e) => {
                ...
                localStorage.setItem("ybex_token", "dev_bypass_admin");
                setUser(fakeUser);
                toast.success("Bypassed login (Admin Mode)");
                navigate("/admin");
              }}
              className="w-full col-span-2 bg-[#EF4444]/10 border border-[#EF4444]/20 py-2 sm:py-2.5 text-xs font-bold text-[#EF4444] hover:bg-[#EF4444]/20 transition-all rounded-xl shadow-sm text-center"
            >
              Dev Bypass (Admin)
            </button>
          </div>
