import fs from 'fs';
let code = fs.readFileSync('src/pages/CreatorUGCBrowse.jsx', 'utf8');
...
if (code.includes(targetStr)) {
  ...
  fs.writeFileSync('src/pages/CreatorUGCBrowse.jsx', code);
  console.log("Success modifying CreatorUGCBrowse");
} else {
  console.log("Not found CreatorUGCBrowse target");
}
