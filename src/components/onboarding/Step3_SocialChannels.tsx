...
export default function Step3_SocialChannels({ user }: { user: any }) {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500 pb-20">
      <div>
        <h2 className="text-3xl font-bold text-[var(--text-primary)]">Social Channels</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-[var(--bg-card)] rounded-2xl border border-transparent bg-clip-padding relative">
            ...
            <div className="space-y-3 flex-1">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[var(--bg-base)] border border-[var(--border-default)] rounded-lg p-2.5 text-[var(--text-primary)] focus:border-[#3B82F6] outline-none"
          ...
          <div className="p-6 h-full flex flex-col">
            <div className="flex justify-between items-start mb-6">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-[var(--text-primary)] text-lg">YouTube</h3>
              </div>
      ...
      <div className="border border-[var(--border-default)] rounded-2xl overflow-hidden bg-[var(--bg-card)]">
        <button
          ...
          className="w-full p-4 flex justify-between items-center text-[var(--text-primary)] font-bold bg-[var(--bg-base)]/50 hover:bg-[var(--bg-base)] transition"
        >
        ...
        <AnimatePresence>
          {showOthers && (
            ...
            >
              <div>
                <label className="text-xs font-medium text-[var(--text-secondary)] mb-1 block flex items-center gap-1">
